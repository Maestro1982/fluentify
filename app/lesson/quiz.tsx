      ...
      <>
        ...
        <div className='flex flex-col gap-y-4 lg:gap-y-8 max-w-lg mx-auto text-center items-center justify-center h-full'>
          ...
          <div className='flex items-center gap-x-4 w-full'>
            <ResultCard
              variant='points'
              value={challenges.length * POINTS_TO_REFILL}
            />
    ...
    <>
      ...
      <div className='flex-1'>
        <div className='flex h-full items-center justify-center'>
          <div className='lg:min-h-[350px] lg:w-[600px] w-full px-10 lg:px-0 flex flex-col gap-y-12'>
            <h1 className='text-lg lg:text-3xl text-center lg:text-start font-bold text-neutral-700 dark:text-slate-500'>
              {title}
            </h1>
            <div>
              {challenge.type === 'ASSIST' && (
